...
class Category extends React.Component {
    ...
    */ 
    ...
    render() {
        ...
        // 轮播图的配置：第一个参数：2.5秒滚动一次 、 第二个参数：callback是每次滚动完获取的索引 index
        // ul的类型会一直被选中 <li class="selected"></li> 控制台鼠标查看
        const opt = {
            auto: 2000,
            // 这里面的this如果不加bind绑定、 this指向会有问题 或者使用箭头函数
            callback: function (index) {
                // 更新当前轮播图的index
                this.setState({ index });
            }.bind(this) // 这里绑定this、否则获取不到this、this.setState不可用
        }
